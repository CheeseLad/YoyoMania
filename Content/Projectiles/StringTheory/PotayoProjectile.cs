...
public class PotayoProjectile : ModProjectile
{
	public override void SetStaticDefaults()
	{
		ProjectileID.Sets.YoyosLifeTimeMultiplier[base.Projectile.type] = float.PositiveInfinity;
		ProjectileID.Sets.YoyosMaximumRange[base.Projectile.type] = 600f;
		ProjectileID.Sets.YoyosTopSpeed[base.Projectile.type] = 50f;
	}
