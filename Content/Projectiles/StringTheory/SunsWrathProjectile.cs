...
public class SunsWrathProjectile : ModProjectile
{
	public override void SetStaticDefaults()
	{
		ProjectileID.Sets.YoyosLifeTimeMultiplier[base.Projectile.type] = float.PositiveInfinity;
		ProjectileID.Sets.YoyosMaximumRange[base.Projectile.type] = 420f;
	...
	private void FireParticles()
	{
		for (int i = 0; i < 2; i++)
		{
			Dust dust = Dust.NewDustDirect(base.Projectile.position, base.Projectile.width, base.Projectile.height, 6, 0f, 0f, 100, default(Color), 1.5f);
			dust.noGravity = true;
			dust.velocity = base.Projectile.velocity.RotatedByRandom(MathHelper.ToRadians(30f));
		}
	}
}
