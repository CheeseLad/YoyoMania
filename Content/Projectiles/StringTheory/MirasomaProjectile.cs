...
public class MirasomaProjectile : ModProjectile
{
	public override void SetStaticDefaults()
	{
		ProjectileID.Sets.YoyosLifeTimeMultiplier[base.Projectile.type] = 7.3f;
		ProjectileID.Sets.YoyosMaximumRange[base.Projectile.type] = 270f;
